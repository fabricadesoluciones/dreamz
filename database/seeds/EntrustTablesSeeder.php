...
class EntrustTablesSeeder extends Seeder
{
    ...
    public function run()
    {
		...
		$list_assessments = new Permission(); $list_assessments->name = 'list-assessments'; $list_assessments->save(); $list_assessments = Permission::where('name','=','list-assessments')->first();
		$edit_assessments = new Permission(); $edit_assessments->name = 'edit-assessments'; $edit_assessments->save(); $edit_assessments = Permission::where('name','=','edit-assessments')->first();
		$list_virtues = new Permission(); $list_virtues->name = 'list-virtues'; $list_virtues->save(); $list_virtues = Permission::where('name','=','list-virtues')->first();
		$edit_virtues = new Permission(); $edit_virtues->name = 'edit-virtues'; $edit_virtues->save(); $edit_virtues = Permission::where('name','=','edit-virtues')->first();
		$edit_one_page = new Permission(); $edit_one_page->name = 'edit-one_page'; $edit_one_page->save(); $edit_one_page = Permission::where('name','=','edit-one_page')->first();

		$super_admin->attachPermissions(array($edit_one_page, $list_virtues, $edit_virtues,$list_assessments,$edit_assessments, $edit_emotions, $progress_objectives, $progress_priorities,$list_users , $edit_users , $list_companies , $edit_companies , $list_departments , $edit_departments , $list_objectives , $edit_objectives , $list_priorities , $edit_priorities , $list_industries , $edit_industries , $list_countries , $edit_countries , $list_languages , $edit_languages , $list_positions , $edit_positions , $list_education , $edit_education , $list_periods , $edit_periods ));
		$coach->attachPermissions(array($edit_one_page, $list_virtues, $edit_virtues,$list_assessments,$edit_assessments, $edit_emotions, $progress_objectives, $progress_priorities,$list_users , $edit_users , $list_companies , $edit_companies , $list_departments , $edit_departments , $list_objectives , $edit_objectives , $list_priorities , $edit_priorities , $list_industries , $edit_industries , $list_countries , $edit_countries , $list_languages , $edit_languages , $list_positions , $edit_positions , $list_education , $edit_education , $list_periods , $edit_periods ));
		$ceo->attachPermissions(array($edit_one_page, $progress_objectives, $progress_priorities,$list_users, $list_departments, $list_objectives, $edit_objectives, $list_priorities, $edit_priorities, $list_industries, $edit_industries));
		$champion->attachPermissions(array($edit_one_page, $list_virtues, $edit_virtues,$list_assessments,$edit_assessments, $edit_emotions, $progress_objectives, $progress_priorities,$list_users, $edit_users, $list_departments, $edit_departments, $list_objectives, $edit_objectives, $list_priorities, $edit_priorities, $list_positions, $edit_positions, $list_education, $edit_education, ));
