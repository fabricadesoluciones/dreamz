...
class EntrustTablesSeeder extends Seeder
{
    ...
    public function run()
    {
		...
		$super_admin->attachPermissions(array($progress_objectives, $progress_priorities,$list_users , $edit_users , $list_companies , $edit_companies , $list_departments , $edit_departments , $list_objectives , $edit_objectives , $list_priorities , $edit_priorities , $list_industries , $edit_industries , $list_countries , $edit_countries , $list_languages , $edit_languages , $list_positions , $edit_positions , $list_education , $edit_education , $list_periods , $edit_periods ));
