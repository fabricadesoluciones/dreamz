            ...
            <div class="grid">
                ...
                <div class="row cells2">
                    <div class="cell">
                        ...
                        <br>
                        <input type="checkbox" readonly="readonly" disabled="disabled" id="type" name="type" value="" 
                        @if($objective->type == 'inverted')
                        checked="true"
                        @endif
                        />
                        </div>
                ...
                <div class="row cells3 inlined">
                    <div class="cell">
                        ...
                        <label for="department">{{trans('general.objectives.green')}}</label>
                           <input placeholder="{{$objective->measuring_unit_name}}"  class="auto" type="number" pattern="[0-9.,]+" step="0.01" name="period_green" id="period_green" value="{{$objective->period_green}}"/>
                        </div>
                    </div>
                    <div class="cell">
                        <div class="input-control text">
                        <label for="department">{{trans('general.objectives.red')}}</label>
                           <input placeholder="{{$objective->measuring_unit_name}}" class="auto" type="number" pattern="[0-9.,]+" step="0.01" name="period_red" id="period_red" value="{{$objective->period_red}}"/>
                        </div>
                    </div>
                    <div class="cell">
                        <div class="input-control text">
            ...
            <div class="grid">
                ...
                <div class="row cells3 inlined">
                    <div class="cell">
                        <div class="input-control text">
                        <label for="department">{{trans('general.objectives.green')}}</label>
                           <input placeholder="{{$objective->measuring_unit_name}}"  class="auto" type="number" pattern="[0-9.,]+" step="0.01" name="daily_green" id="daily_green" value="{{$objective->daily_green}}"/>
                        </div>
                    </div>
                    <div class="cell">
                        <div class="input-control text">
                        <label for="department">{{trans('general.objectives.red')}}</label>
                           <input placeholder="{{$objective->measuring_unit_name}}" class="auto" type="number" pattern="[0-9.,]+" step="0.01" name="daily_red" id="daily_red" value="{{$objective->daily_red}}"/>
                        </div>
                    </div>
                    <div class="cell">
                        <div class="input-control text">
...
function returnNotify(msg, title, type){
    ...
    KPI = {}
    KPI.type = '{{$objective->type}}';
    KPI.period = {},
    KPI.daily = {},
    KPI.period.target_value = parseFloat($('#period_objective').val());
    KPI.period.green = parseFloat($('#period_green').val());
    KPI.period.red = parseFloat($('#period_red').val());
    KPI.daily.target_value = parseFloat($('#daily_objective').val());
    KPI.daily.green = parseFloat($('#daily_green').val());
    KPI.daily.red = parseFloat($('#daily_red').val());
